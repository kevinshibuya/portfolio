...
5. `## NO`. The items from spec decision 4, one line each with the reason in a few words. (Fifteen as planned; fourteen after the PR review cut the duplicated em-dash item.)
