...
5. `## NO`. The items from spec decision 4, one line each with the reason in a few words. (Fifteen; the PR review swapped the duplicated em-dash item for the faded-token one.)
