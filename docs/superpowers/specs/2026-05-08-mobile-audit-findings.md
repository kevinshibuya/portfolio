...
- [ ] **V1**: `.archive-list` top sits ≤ 40 px below `.archive-count` on every mobile viewport (currently 96 px).
- [ ] **V2**: zero `.project-detail-route-label` elements report `right > viewport-width` at the 320 viewport (currently 19).
