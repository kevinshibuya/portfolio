...
- [ ] Loading screen renders, fills its progress underline as assets resolve, and hands the `kevin` / `shibuya.` words off to their final hero positions without remount or visible discontinuity (bounding-box continuity verified at frame boundaries).
