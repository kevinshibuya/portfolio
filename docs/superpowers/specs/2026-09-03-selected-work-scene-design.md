...
| Q12 | Depth of field: focus distance tracks the **slot**; the title sits inside the focal range so it is crisp at rest; modest bokeh, no visible discs; **desktop only**. |
